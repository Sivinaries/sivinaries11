                            ...
                            <tbody>
                                ...
                                @foreach ($expenses as $item)
                                    <tr class="border-2">
                                        ...
                                        <td>{{ $item->name ?? 'N/A'}}</td>
                                        <td>Rp. {{ number_format($item->nominal, 0, ',', '.') ?? 'N/A'}} </td>
                                        <td class="flex gap-2">
                                            <div class="w-full">
                                                <a href="{{ route('editexpense', ['id' => $item->id]) }}">
                                                    <h1
                                            ...
                                            <div class="w-full">
                                                <form
                                                    ...
                                                    method="post"
                                                    action="{{ route('delexpense', ['id' => $item->id]) }}">
                                                    @csrf
                                                    @method('delete')
